...
set -euo pipefail
# =============================================================================
# NW Fault Dojo — シナリオ01 切り戻しスクリプト
...
PAYLOAD_B64_1="Y29uZiB0CmludGVyZmFjZSBlMS8zCiBzd2l0Y2hwb3J0IGFjY2VzcyB2bGFuIDEwCm5vIHZsYW4gOTkKZW5kCg=="
