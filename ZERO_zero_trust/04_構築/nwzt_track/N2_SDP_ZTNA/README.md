...
> **2026-07-05 実装済み・実機検証済み。** SDP ダークサービス（内向き非開放＋認可済みのみ overlay 到達）を OpenZiti(arm64) で実証（実装先: テーマ36 `36_ztna_openziti/`）。client→overlay=HTTP 200 / client→直接=HTTP 000。詳細は [試験結果](../../../../36_ztna_openziti/05_試験/試験結果_2026-07-05.md)・[構築ログ](../../../../36_ztna_openziti/04_構築/構築ログ_2026-07-05.md)。以下は当初の設計スタブ。
