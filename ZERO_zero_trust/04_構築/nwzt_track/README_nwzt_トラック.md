...
| N | 観点 | スタブ | 主実装先 |
|---|---|---|---|
| N1 | NAC / 802.1X | [N1_NAC/README.md](N1_NAC/README.md) | テーマ31（NAC/802.1X）— [ロードマップPHASE2](../../../ロードマップ/PHASE2_MODERN_ENTERPRISE.md) 経由 |
| N2 | SDP型ZTNA | [N2_SDP_ZTNA/README.md](N2_SDP_ZTNA/README.md) | テーマ36（OpenZiti） |
| N3 | NDR | [N3_NDR/README.md](N3_NDR/README.md) | テーマ42（＋テーマ35 Faucet 連携）— [ロードマップPHASE2](../../../ロードマップ/PHASE2_MODERN_ENTERPRISE.md) 経由 |
| N4 | μセグメンテーション | [N4_microseg/README.md](N4_microseg/README.md) | microseg_cilium／microseg_nftables |

31/35/36/42・microseg_* は実在するため各スタブから直リンク可（build.mjsがリンク解決を検証）。実装工程の系列としては [ロードマップPHASE2](../../../ロードマップ/PHASE2_MODERN_ENTERPRISE.md) も併せて参照する。
