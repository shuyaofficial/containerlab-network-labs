...
> **NW-ZT Console**（統合ゼロトラスト運用コンソール・single pane of glass）: [console/](nwzt_console/README_console.md) ／ 公開版 <https://shuyaofficial.github.io/containerlab-network-labs/console/>

| 入口 | 内容 |
|---|---|
| [nwzt_console/](nwzt_console/README_console.md) | NW-ZT 4観点を1画面で見せる運用コンソール（実データ・外部依存ゼロ・Pages配信） |
